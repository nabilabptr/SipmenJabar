...
const hapus_all_record = async (page, id_hapus) => {
  if (page.url != DISTRIBUSI_URL) {
...
(async () => {
  ...
  await pengambilan(page)

  await pengembalian(page)

  const id_hapus = "32753213"

  await hapus_all_record(page, id_hapus)
